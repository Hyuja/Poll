...
urlpatterns = [
    ...
    path('poll/', usv.poll, name = "poll"),
    path('pollprocess/<str:id>', usv.pollprocess, name = "pollprocess"),
    path('end/', usv.end, name = "end"),
    ...
    path('adminaccess/CandidateEdit/editprocess/<str:id>', adv.CandidateEdit_editprocess, name = "update"),
    path('adminaccess/CandidateEdit/delete/<str:id>', adv.CandidateEdit_delete, name = "delete"),
